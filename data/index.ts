...
export const workExperience = [
  {
    ...
    desc: `As a React developer at Maxsole Technologies, my role involves
designing and building client-side Email components for
the company's web applications. I utilize my expertise in
React.js to create responsive user interfaces.
`,
...
export const techStack = {
  stack1: ["React.js", "Vue,js", "Typescript"],
  stack2: ["Django", "AWS", "PostgreSQL"],
} as const;
